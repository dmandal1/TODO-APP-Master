...
let AuthService = class AuthService {
    ...
    loginUser(user) {
        this.http.post(this.loginUrl, user, this.httpOptions).subscribe(res => {
...
let ResgisterComponent = class ResgisterComponent {
    constructor(_authService, router) {
        this._authService = _authService;
        this.router = router;
        this.email = '';
...
ResgisterComponent.ctorParameters = () => [
    { type: _auth_service__WEBPACK_IMPORTED_MODULE_2__["AuthService"] },
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"] }
];
...
let TodoService = class TodoService {
    ...
    createTodo(todo) {
        this.http.post(this.createTodoUrl, todo, this.httpOptions).subscribe(result => {
            console.log(result);
            this.getAllTodos();
        }, err => {
            console.log(err);
    ...
    getAllTodos() {
        this.http.get(this.getAllTodosUrl).subscribe(result => {
    ...
    deleteTodo(id) {
        this.http.delete(this.deleteTodoUrl + `/${id}`).subscribe(res => {
            console.log(res);
            this.getAllTodos();
        }, err => {
            console.log(err);
...
let TodoComponent = class TodoComponent {
    constructor(todoService, _authService, router) {
        this.todoService = todoService;
        this._authService = _authService;
        this.router = router;
        this.todo = '';
